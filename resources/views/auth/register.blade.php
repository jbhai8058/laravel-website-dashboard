                  ...
                  <x-validation-errors class="mb-4 text-danger" />
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group col-md-12 mb-4">
                            <input type="text" class="form-control input-lg" name="name" aria-describedby="nameHelp" placeholder="Name" required autocomplete="name">
                        </div>
                        <div class="form-group col-md-12 mb-4">
                            <input type="email" class="form-control input-lg" name="email" aria-describedby="emailHelp" placeholder="Username" required autocomplete="username">
                        </div>
